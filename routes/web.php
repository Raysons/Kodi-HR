...
Route::group(["namespace" => 'Admin', 'middleware' => ['auth.admin', 'auth.screenlock', 'plan.null'], 'prefix' => 'admin'], function () {
    ...
    Route::resource('leave_applications', 'LeaveApplicationsController', ['except' => ['create', 'store', 'edit'], 'as' => 'admin']);
	 ...
	 //    Projects routing
    Route::get('create_projects/ajaxApplications', ['as' => 'admin.create_projects', 'uses' => 'Projects@ajaxApplications']);
    Route::resource('create_projects', 'ProjectsController', ['except' => ['create', 'store', 'edit'], 'as' => 'admin']);
	
    //    Timesheet Applications routing
    Route::get('timesheet_applications/ajaxApplications', ['as' => 'admin.timesheet_applications', 'uses' => 'TimeApplicationsController@ajaxApplications']);
    Route::resource('time_applications', 'TimesheetApplicationsController', ['except' => ['create', 'store', 'edit'], 'as' => 'admin']);
